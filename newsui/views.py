...
df.to_pickle(r'C:\Users\20311107\env_site\Scripts\news\newsui\newsdata.pkl')
...
def tagdata(defencelst,political,economic,technology,collab,competitor,p_75,submarines):
    tmpdf=pd.read_pickle(r"C:\Users\20311107\env_site\Scripts\news\newsui\newsdata.pkl")
    lst=[]
...
def home(request):
    ...
    for i in ['LOC','NORP','GPE','ORG','PERSON']:
        ...
        wordcloud.to_file(r'C:\Users\20311107\env_site\Scripts\news\static\img\\'+i+'.png')
